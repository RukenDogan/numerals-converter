...
def conversion_arabe_romain(nb):
    ...
    # Tri des clés du dictionnaire en ordre décroissant :
    cles_triees = sorted(conversion_nb.keys(), reverse=True)

    # Parcours des clés triées :
    for key in cles_triees: # Pour chaque clé triée
        while nb >= key: # Tant que le nombre est supérieur ou égal à la clé courante
